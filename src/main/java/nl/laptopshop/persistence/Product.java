...
public class Product {
	...
	public Product(String resolutie, int werkgeheugen, String model, double prijs, int kaart, int processor, int opslag, int leverancier) {
	...
	public Product(int id, String resolutie, int werkgeheugen, String model, double prijs, String kaartNaam, String processorNaam, String opslagNaam,int opslagcapaciteit, String leverancierNaam) {
		this.id = id;
		this.resolutie = resolutie;
		this.werkgeheugen = werkgeheugen;
		this.model = model;
		...
		this.setOpslagcapaciteit(opslagcapaciteit);
	...
	public int getOpslagcapaciteit() {
		return opslagcapaciteit;
	}

	public void setOpslagcapaciteit(int opslagcapaciteit) {
